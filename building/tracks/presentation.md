...
The CLI will create a `README.md` and `HINTS.md` file that contain the above documentation file's contents, except for the `debug.md` document.
...
The CLI will create a `README.md` and `HINTS.md` file that contain the above documentation file's contents, except for the `debug.md` document. The two append files will be appended.
